...
## Project Structure
    ...
    ├── testapiautostoryboa_76854  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_76854`
...
2. Clone this repo and `cd testapiautostoryboa_76854`
